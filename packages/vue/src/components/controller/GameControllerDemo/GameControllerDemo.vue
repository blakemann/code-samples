...
<script setup lang="ts">
  ...
  import GameController from '@/vue/components/controller/GameController';
  import LogBox from '@/vue/components/controller/LogBox';
  import type { LogEntry } from '@/vue/components/controller/LogBox';
