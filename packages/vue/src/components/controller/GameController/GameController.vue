...
<script lang="ts">
  ...
  import ActionButton, { ActionButtonColor } from '@/vue/components/controller/ActionButton';
  import DirectionalButton, { DirectionalButtonDirection } from '@/vue/components/controller/DirectionalButton';
  import AnalogStick from '@/vue/components/controller/AnalogStick';
  import ControllerBody from '@/vue/components/controller/ControllerBody';
  import MenuButton, { MenuButtonSide } from '@/vue/components/controller/MenuButton';
  import MuteButton from '@/vue/components/controller/MuteButton';
  import PlayStationButton from '@/vue/components/controller/PlayStationButton';
  import ShoulderButton, { ShoulderButtonSide } from '@/vue/components/controller/ShoulderButton';
  import TouchPad from '@/vue/components/controller/TouchPad';
